...
contract StarNotary is ERC721 {
    ...
    string public name = 'Egyptian Star';
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    string public symbol = 'LE'; // 'Egyptian Pound'
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(firstOwnerAddress == msg.sender || secondOwnerAddress == msg.sender, "Sender is not the owner");
